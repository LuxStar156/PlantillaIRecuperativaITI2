...
<html lang="es">
<head>
    <title>Infraestructura tecnólogica </title>
    <!-- Meta -->
    <meta charset="utf-8">
    ...
    <link rel="shortcut icon" href="server.ico">  
...
<body class="landing-page">   
            ...
            <div class="container">
                <div class="branding">
                    <h1 class="logo">
                        ...
                        <span class="text-highlight">Infraestructura</span><span class="text-bold">Tecnológica </span><span class="text-highlight">2</span>
                    </h1>
                    </h1>
                </div><!--//branding-->
                <div class="tagline">
                ...
                <div class="social-container">
	                ...
	                <div class="github-btn mb-2">
						<a class="github-button" href="https://github.com/LuxStar156/plantilla.git" data-size="large" aria-label="Star xriley/PrettyDocs-Theme on GitHub">Repositorio</a>
                        <a class="github-button" href="https://github.com/LuxStar156" data-size="large" aria-label="Follow @xriley on GitHub">Sigue a @LuxStar156</a>
	                </div>
    ...
    <footer class="footer text-center">
        <div class="container">
            ...
            <small class="copyright">Plantilla original hecha por <a href="https://themes.3rdwavemedia.com/" target="_blank">Xiaoying Riley</a>, muchas gracias </small>
